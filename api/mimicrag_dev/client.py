...
class Client:
    ...
    def remember(self, subject: str, statement: str, evidence: list[Any] | None = None, **options): return self.request("POST", "/v1/memory/remember", {"subject": subject, "statement": statement, "evidence": evidence or [], **options})
    ...
    def correct_memory(self, memory_id: str, statement: str, evidence: list[Any] | None = None, **options): return self.request("POST", "/v1/memory/correct", {"memory_id": memory_id, "statement": statement, "evidence": evidence or [], **options})
